 ...
 * File Contents
 *
 *      Registration page for the TA Application website, changed the fields to umail account, and to require a Unid.
*/
...
namespace TAApplication.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [EmailAddress]
            [Display(Name = "UofU Email")]
            public string Email { get; set; }


            [Required]
            [RegularExpression("^u[0-9]{7}")]
            [Display(Name = "UofU ID")]
            ...
            [Display(Name = "How would you like to be referred to?")]
        ...
        /// <summary>
        /// Creates the user into the databse, using inputs of the registration form
        /// </summary>
